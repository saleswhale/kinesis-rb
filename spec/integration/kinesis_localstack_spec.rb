...
describe 'Kinesis with Localstack', integration: true do
  ...
  # # Change xit to it to enable the Enhanced Fan-Out test
  # it 'can use enhanced fan-out' do
  ...
  #       table_name: 'test-table',
  #       consumer_group: 'test-group',
  #       endpoint: LocalstackHelper::LOCALSTACK_ENDPOINT,
  #       region: LocalstackHelper::LOCALSTACK_REGION,
  #       credentials: LocalstackHelper::LOCALSTACK_CREDENTIALS,
  #       client: LocalstackHelper.dynamodb_client  # Provide the pre-configured client directly
  #     },
  #     kinesis: {
  #       endpoint: LocalstackHelper::LOCALSTACK_ENDPOINT,
  #       region: LocalstackHelper::LOCALSTACK_REGION,
  #       credentials: LocalstackHelper::LOCALSTACK_CREDENTIALS,
  #       client: LocalstackHelper.kinesis_client  # Provide the pre-configured client directly
  #     },
